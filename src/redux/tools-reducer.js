...
const toolsReducer = (state = initialState, action) => {
  switch (action.type) {
    case SHOW_MODAL_BY_NAME:
      return {
        ...state, activeModalWindowName: action.newModalWindowName
      }
    case SET_MODAL_WINDOW_BUSY:
      return {
        ...state, modalWindowBusy: true
      }
    case UNSET_MODAL_WINDOW_BUSY:
      return {
        ...state, modalWindowBusy: false
      }
    case SET_TEXT_MODAL_WINDOW_BUSY:
      return {
        ...state, modalWindowBusyText: action.modalWindowBusyText
      }
    case UPDATE_SCREEN_SIZE:
      return {
        ...state, screenSize: action.screenSize
      }
    ...
    case SET_FORM_TEL:
      return {
        ...state, userForm: {...state.userForm, formTel: action.formTel}
      }
    case TOGGLE_RIGHT_PERSONAL_DATA:
      ...
      return {
        ...state, userForm: {...state.userForm, rightsPersonalData: newRightsPersonalData}
      }
    default:
      return state;
  }
...
export const showModalWindowByName = (newModalWindowName) => ({type: SHOW_MODAL_BY_NAME, newModalWindowName})
...
export const setTextModalWindowBusy = (modalWindowBusyText) => ({type: SET_TEXT_MODAL_WINDOW_BUSY, modalWindowBusyText})

export const toggleRightsPersonalData = () => ({type: TOGGLE_RIGHT_PERSONAL_DATA})

export const updateScreenWidth = () => ({
  type: UPDATE_SCREEN_SIZE, screenSize: {
    width: typeof window === 'object' ? window.innerWidth : null ,
