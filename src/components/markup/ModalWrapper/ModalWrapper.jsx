...
const ModalWrapper = ({ title, active, showModalWindowByName, hideModalWindow,
                        animation=true, children, ...data}) => {
  ...
  function newTaskAfterTimeout(newTask, sec) {
    setTimeout(()=>{setTaskModal(newTask)}, sec, newTask)
  }
  ...
  return (
    <>
      <div onClick={()=>{hideModalWindow()}}>ффф--открыта---фф</div>
