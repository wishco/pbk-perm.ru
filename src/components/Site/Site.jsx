...
import {AlertProvider, useAlert} from "components/AlertContextTest/AlertContext";
...
const Site = ({activeModalWindowName, showModalWindowByName, hideModalWindow, updateScreenWidth, ...data}) => {
            ...
            <div className={s.top}>
              ...
              <Switch>
                ...
                <Route key={`/live`} exact path={`/live`}
                       render={() => <Redirect to={`/live/snesh-skazka`}/>}/>
                <Route key={`/commerce`} exact path={`/commerce`}
                       render={() => <Redirect to={`/commerce/snesh-skazka`}/>}/>
              </Switch>

              <Header pos={'top'}/>

              <Route exact path='/live/snesh-skazka' render={() => <SneshSkazkaLiveContainer/>}/>
              <Route exact path='/commerce/snesh-skazka' render={() => <SneshSkazkaCommerceContainer/>}/>
              <Route exact path='/realtor' render={() => <Realtor/>}/>
              <Route exact path='/ways-buy' render={() => <WaysBuy/>}/>

              <Route exact path='/live/snesh-skazka/add' render={() => <PagePlaceToServer/>}/>
              <Route exact path='/commerce/snesh-skazka/add' render={() => <PagePlaceToServer/>}/>
