    ...
    <>
      ...
      <div className={s.wrapperImage}>
        ...
        <div className={s.containerText}>
          <div className={s.wrapperText}>
            ...
            <p className={s.textImageTitle}>Дом Снежная Сказка</p>
      ...
      <Wrapper>
        <Container className={s.containerRooms}>
          <RoomBannerContainer href={`#${idInfo}`} nameBuild="snesh-skazka" styleElements={{
            rooms: 1,
            text1: "Однокомнатные",
            text2: "от 1,8 млн.руб.",
            text3: "площадь от 35 кв.м.",
            filterRoom: "П1"
          }}/>
          <RoomBannerContainer href={`#${idInfo}`} nameBuild="snesh-skazka" styleElements={{
            rooms: 2,
            text1: "Двухкомнатные",
            text2: "от 2,4 млн.руб.",
            text3: "площадь от 45 кв.м.",
            filterRoom: "П2-"
          }}/>
          <RoomBannerContainer href={`#${idInfo}`} nameBuild="snesh-skazka" styleElements={{
            rooms: 2,
